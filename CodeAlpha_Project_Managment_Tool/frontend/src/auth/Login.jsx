    ...
    <div className="min-h-screen bg-dark-bg flex items-center justify-center p-4">
      <div className="w-full max-w-md">
        ...
        <div className="card">
          ...
          <div
            onClick={fillDemo}
            className="bg-primary bg-opacity-10 border border-primary 
                       border-opacity-30 rounded-lg p-3 mb-5 cursor-pointer 
          ...
          >
            ...
            <p className="text-text-secondary text-xs">
              Email: kaushalpatel2506@gmail.com &nbsp;|&nbsp; Password: kaushal
            </p>
          </div>
